...
namespace FmiWrapper_Net
{
    ...
    public static class FmiFunctions
    {
        ...
        [DllImport("fmi_wrapper.dll", EntryPoint = "instantiate", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("fmi_wrapper.dll", EntryPoint = "free_instance", CallingConvention = CallingConvention.Cdecl)]
        internal static extern void FreeInstance(IntPtr wrapper);

        [DllImport("fmi_wrapper.dll", EntryPoint = "set_debug_logging", CallingConvention = CallingConvention.Cdecl)]
        ...
        /// <param name="wrapper"></param>
        /// <returns></returns>
        [DllImport("fmi_wrapper.dll", EntryPoint = "get_types_platform", CallingConvention = CallingConvention.Cdecl)]
        ...
        /// <param name="wrapper"></param>
        /// <returns></returns>
        [DllImport("fmi_wrapper.dll", EntryPoint = "get_version", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("fmi_wrapper.dll", EntryPoint = "setup_experiment", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("fmi_wrapper.dll", EntryPoint = "enter_initialization_mode", CallingConvention = CallingConvention.Cdecl)]
        internal static extern Fmi2Status EnterInitializationMode(IntPtr wrapper);

        [DllImport("fmi_wrapper.dll", EntryPoint = "exit_initialization_mode", CallingConvention = CallingConvention.Cdecl)]
        internal static extern Fmi2Status ExitInitializationMode(IntPtr wrapper);

        [DllImport("fmi_wrapper.dll", EntryPoint = "terminate", CallingConvention = CallingConvention.Cdecl)]
        internal static extern Fmi2Status Terminate(IntPtr wrapper);

        [DllImport("fmi_wrapper.dll", EntryPoint = "reset", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("fmi_wrapper.dll", EntryPoint = "get_real", CallingConvention = CallingConvention.Cdecl)]
        internal static extern Fmi2Status GetReal(IntPtr wrapper, uint[] vr, UIntPtr nvr, [Out] double[] value);

        [DllImport("fmi_wrapper.dll", EntryPoint = "get_integer", CallingConvention = CallingConvention.Cdecl)]
        internal static extern Fmi2Status GetInteger(IntPtr wrapper, uint[] vr, UIntPtr nvr, [Out] int[] value);

        [DllImport("fmi_wrapper.dll", EntryPoint = "get_boolean", CallingConvention = CallingConvention.Cdecl)]
        ...
        /// <returns></returns>
        [DllImport("fmi_wrapper.dll", EntryPoint = "get_string", CallingConvention = CallingConvention.Cdecl)]
        internal static extern Fmi2Status GetString(IntPtr wrapper, uint[] vr, UIntPtr nvr, [Out] IntPtr[] value);

        // Set values

        [DllImport("fmi_wrapper.dll", EntryPoint = "set_real", CallingConvention = CallingConvention.Cdecl)]
        internal static extern Fmi2Status SetReal(IntPtr wrapper, uint[] vr, UIntPtr nvr, double[] value);

        [DllImport("fmi_wrapper.dll", EntryPoint = "set_integer", CallingConvention = CallingConvention.Cdecl)]
        internal static extern Fmi2Status SetInteger(IntPtr wrapper, uint[] vr, UIntPtr nvr, int[] value);

        [DllImport("fmi_wrapper.dll", EntryPoint = "set_boolean", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("fmi_wrapper.dll", EntryPoint = "set_string", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("fmi_wrapper.dll", EntryPoint = "enter_event_mode", CallingConvention = CallingConvention.Cdecl)]
        internal static extern Fmi2Status EnterEventMode(IntPtr wrapper);

        [DllImport("fmi_wrapper.dll", EntryPoint = "new_discrete_states", CallingConvention = CallingConvention.Cdecl)]
        internal static extern Fmi2Status NewDiscreteStates(IntPtr wrapper, ref Fmi2EventInfo eventInfo);

        [DllImport("fmi_wrapper.dll", EntryPoint = "enter_continuous_time_mode", CallingConvention = CallingConvention.Cdecl)]
        internal static extern Fmi2Status EnterContinuousTimeMode(IntPtr wrapper);

        [DllImport("fmi_wrapper.dll", EntryPoint = "completed_integrator_step", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("fmi_wrapper.dll", EntryPoint = "set_time", CallingConvention = CallingConvention.Cdecl)]
        internal static extern Fmi2Status SetTime(IntPtr wrapper, double time);

        [DllImport("fmi_wrapper.dll", EntryPoint = "set_continuous_states", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("fmi_wrapper.dll", EntryPoint = "get_derivatives", CallingConvention = CallingConvention.Cdecl)]
        internal static extern Fmi2Status GetDerivatives(IntPtr wrapper, [Out] double[] derivatives, UIntPtr nx);

        [DllImport("fmi_wrapper.dll", EntryPoint = "get_event_indicators", CallingConvention = CallingConvention.Cdecl)]
        internal static extern Fmi2Status GetEventIndicators(IntPtr wrapper, [Out] double[] eventIndicators, UIntPtr ni);

        [DllImport("fmi_wrapper.dll", EntryPoint = "get_continuous_states", CallingConvention = CallingConvention.Cdecl)]
        internal static extern Fmi2Status GetContinuousStates(IntPtr wrapper, [Out] double[] x, UIntPtr nx);

        [DllImport("fmi_wrapper.dll", EntryPoint = "get_nominals_of_continuous_states", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("fmi_wrapper.dll", EntryPoint = "set_real_input_derivatives", CallingConvention = CallingConvention.Cdecl)]
        internal static extern Fmi2Status SetRealInputDerivatives(IntPtr wrapper, uint[] vr, UIntPtr nvr, int[] order, double[] value);

        [DllImport("fmi_wrapper.dll", EntryPoint = "get_real_output_derivatives", CallingConvention = CallingConvention.Cdecl)]
        internal static extern Fmi2Status GetRealOutputDerivatives(IntPtr wrapper, uint[] vr, UIntPtr nvr, int[] order, [Out] double[] value);

        [DllImport("fmi_wrapper.dll", EntryPoint = "do_step", CallingConvention = CallingConvention.Cdecl)]
        internal static extern Fmi2Status DoStep(IntPtr wrapper,
            double currentCommunicationPoint, double communicationStepSize,
            [MarshalAs(UnmanagedType.Bool)] bool noSetFmuStatePriorToCurrentPoint);

        [DllImport("fmi_wrapper.dll", EntryPoint = "cancel_step", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("fmi_wrapper.dll", EntryPoint = "get_status", CallingConvention = CallingConvention.Cdecl)]
        internal static extern Fmi2Status GetStatus(IntPtr wrapper, Fmi2StatusKind statusKind, ref Fmi2Status value);

        [DllImport("fmi_wrapper.dll", EntryPoint = "get_real_status", CallingConvention = CallingConvention.Cdecl)]
        internal static extern Fmi2Status GetRealStatus(IntPtr wrapper, Fmi2StatusKind statusKind, ref double value);

        [DllImport("fmi_wrapper.dll", EntryPoint = "get_integer_status", CallingConvention = CallingConvention.Cdecl)]
        internal static extern Fmi2Status GetIntegerStatus(IntPtr wrapper, Fmi2StatusKind statusKind, ref int value);

        [DllImport("fmi_wrapper.dll", EntryPoint = "get_boolean_status", CallingConvention = CallingConvention.Cdecl)]
        ...
        /// <returns></returns>
        [DllImport("fmi_wrapper.dll", EntryPoint = "get_string_status", CallingConvention = CallingConvention.Cdecl)]
